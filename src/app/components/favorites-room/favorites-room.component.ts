...
@Component({
  selector: 'app-favorites-room',
  imports: [PropertiesListComponent, PropertiesGridComponent],
  templateUrl: './favorites-room.component.html',
  styleUrl: './favorites-room.component.css'
})
export class FavoritesRoomComponent {
