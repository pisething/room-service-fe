...
@Component({
  selector: 'app-properties-active-filters',
  imports: [],
  templateUrl: './properties-active-filters.component.html',
  styleUrl: './properties-active-filters.component.css'
})
export class PropertiesActiveFiltersComponent {
